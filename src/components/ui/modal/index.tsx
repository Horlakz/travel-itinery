...
export function Modal(props: ModalProps) {
  ...
  return (
    <AnimatePresence>
      {props.visibility && (
        <motion.div
          className="fixed z-50 w-full h-full left-0 top-0 py-4 px-3 md:px-6 bg-[rgba(0,0,0,0.3)] grid place-content-center"
        ...
        >
          <motion.div
            className="shadow-lg w-fit mx-auto relative bg-white/90 rounded-3xl"
            variants={modalVariants}
          >
            {props.children}
